...
html_theme_options = {
    ...
    "repository_url": "https://github.com/huchlab/sequencing-docker-stacks",
...
linkcheck_ignore = [
    ...
    r"https://star-history\.com/#.*",  # client-side routing, link checker can't verify
]

linkcheck_allowed_redirects = {
    r"https://results\.pre-commit\.ci/latest/github/huchlab/sequencing-docker-stacks/main": r"https://results\.pre-commit\.ci/run/github/.*",  # Latest main CI build
    r"https://github\.com/huchlab/sequencing-docker-stacks/issues/new.*": r"https://github\.com/login.*",  # GitHub wants user to be logon to use this features
