# Jupyter Notebook Multiomics GPU Stack
...
This image extends `multiomics-notebook` with GPU-acceleration from [rapids-singlecell](https://rapids-singlecell.readthedocs.io/)
...
```bash
docker run --gpus all -p 8888:8888 quay.io/huchlab/multiomics-gpu-notebook:cuda13-latest
```
