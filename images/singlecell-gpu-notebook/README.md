# Jupyter Notebook Singlecell GPU Stack
...
This image extends `singlecell-notebook` with GPU-acceleration from [rapids-singlecell](https://rapids-singlecell.readthedocs.io/)
...
```bash
docker run --gpus all -p 8888:8888 quay.io/huchlab/singlecell-gpu-notebook:cuda13-latest
```
